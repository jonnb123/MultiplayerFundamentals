...
void AMultiplayerCourseCharacter::ServerRPCFunction_Implementation(int MyArg)
{
	...
	{
#if 0
		GEngine->AddOnScreenDebugMessage(-1, 15.0, FColor::Green, TEXT("Server: ServerRPCFunction_Implementation"));
#endif
		GEngine->AddOnScreenDebugMessage(-1, 15.0, FColor::Green, FString::Printf(TEXT("MyArg: %d"), MyArg));
		if (!SphereMesh)
		{
			return;
		}
...
// If false, the _Implementation will not be executed and the client is kicked 
